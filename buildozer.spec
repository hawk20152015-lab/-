...
# الامتدادات التي تُضمّن داخل الـ APK (ttf للخط، png للأيقونة)
...
# (الوسم الصحيح v2024.01.21 — آخر إصدار مستقر، ومعه وصفة Kivy 2.3.0)
...
# أيقونة التطبيق (قاصة) — في الجذر مباشرة
